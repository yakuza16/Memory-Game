import { WinningModal } from "./WinningModal.js";
...
export class MemoryGame {
  ...
  showCard(e) {
    ...
    if (
      this.pickedCards.length === this.pickedCardsMaxLength &&
  ...
  getClassnameForIcons() {
    ...
    const doubleIconsArray = [...allIconsOnce, ...allIconsOnce]
      .join("")
      .split(".")
      .slice(1);
